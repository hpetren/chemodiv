...
#' to biosynthetic groups/pathways. Classifications are fetched from
...
#' See \url{https://pubchemdocs.ncbi.nlm.nih.gov/data-specification} for
#' information on PubChem Fingerprints.
