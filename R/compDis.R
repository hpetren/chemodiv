...
#' 1. Using the classification from the NPClassifier tool (Kim et al 2021).
...
#' \url{https://npclassifier.ucsd.edu/}. ADD DETAILS ON PSEUDOVARIABLES
#' WHEN THAT IS DONE.
#' 2. Using PubChem Fingerprints. This is a binary substructure fingerprint with
...
#' information.
#' 3. fMCS, flexible Maximum Common Substructure. This is
