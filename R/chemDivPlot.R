...
#'
#' The function can create four different types of plots depending on
...
#' values of q will be plotted with \code{divProfData}.
...
#' generated by the \code{\link{calcDiv}} function. This dataframe can
...
#' the \code{\link{sampleDis}} function. This can be either the list of one or
...
#'
#' @return Various plots on chemodiversity, created using \code{ggplot2}.
#'
#' @export
#'
#' @examples
