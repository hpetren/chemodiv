...
#' of phytochemical (and similar) data on e.g. chemical defence compounds,
#' floral scent and green leaf volatiles.
#' Analyses are centered around calculations of diversity and
#' molecular/biosynthetic similarity, both separately and combined.
#' Analyses in this R-package will work best for sets of data, commonly
#' generated by chemical ecologists using GC-MS, LC-MS or similar, where all or
#' most compounds in the samples have been confidently identified.
#'
