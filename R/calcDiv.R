...
#' (weighed by their proportions) compounds in the sample.
...
#' Tuomisto 2012 . This is equal to the Hill Diversity, at a given value of q,
#' divided by the number of compounds, and therefore
